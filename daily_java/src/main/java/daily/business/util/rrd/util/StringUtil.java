...
//        System.out.println(StringUtil.isNegativeDecimal("-0.1"));
        ...
        System.out.println(StringUtil.hideNickName("a"));
        System.out.println(StringUtil.hideNickName("ab"));
        System.out.println(StringUtil.hideNickName("abc"));
        System.out.println(StringUtil.hideNickName("1ab1c"));
        System.out.println(StringUtil.hideNickName(""));
        System.out.println(StringUtil.hideNickName("暗紅色的"));
        System.out.println(StringUtil.hideNickName("張"));
        System.out.println(StringUtil.hideNickName("二嘎"));
...
*/
    ...
    public static <T> T deepcopy(T obj) throws Exception {
        ...
        if (Serializable.class.isAssignableFrom(obj.getClass())) {
            // 如果子类没有继承该接口，这一步会报错
            try {
                return deepcopySerializable(obj);
            } catch (Exception e) {
                // 这里不处理，会运行到下面的尝试json
            }
        }
...
//                e.printStackTrace();
     ...
     *
     * @return
     * @see com.renrendai.model.User.getDisplayNameFuzzy
     */
     ...
     * @return
     */
    public static String hideNickName(String src){
        try{
            if (StringUtil.empty(src)) {
                return src;
            } else {
                ...
                if (length == 1) {
                    ...
                    return src.charAt(0)+"***"+src.charAt(length-1);
                }
            }
        }catch (Exception e){
            e.printStackTrace();
