...
public class AES {
    ...
    private static byte[] encrypt(byte[] seed, byte[] input) throws AESFailedException {
        return crypt(seed, input, Cipher.ENCRYPT_MODE);
    }

    private static byte[] decrypt(byte[] seed, byte[] input) throws AESFailedException {
        return crypt(seed, input, Cipher.DECRYPT_MODE);
    }

    private static byte[] crypt(byte[] seed, byte[] input, int mode) throws AESFailedException {
