...
public class NumberUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(BigDecimalMathUtils.div("1230","10000",3));
    ...
    public static String numberFormatConvert(BigDecimal number)
    {
        ...
        if (number!=null)
        {
            ...
            double resultNum1=BigDecimalMathUtils.div(numParam,"10000",2); //产品定义，不处理不能被100整除的数据
            double resultNum2=BigDecimalMathUtils.div(numParam,"1000",1);
            double resultNum3=BigDecimalMathUtils.div(numParam,"100",0);
            if (resultNum1>=1)
            {
