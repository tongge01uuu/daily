...
public class ValidateUtil {
     ...
     * @return
     */
    public IdcardUtil getIdcardUtil(String idcard) {
        if (!isEmpty(idcard)) {
            return new IdcardUtil(idcard);
        }
        return null;
    }

    private IdcardUtil getIdcardUtil() {
    ...
    public static boolean isIdCard(String idcard) {
        if (!isEmpty(idcard)) {
            return ValidateUtil.getInstance().getIdcardUtil().isValidatedAllIdcard(idcard);
        }
        return false;
    }
    ...
    public class IdcardUtil {
         ...
         */
        private String codeAndCity[][] = { { "11", "北京" }, { "12", "天津" }, { "13", "河北" }, { "14", "山西" },
        ...
        public IdcardUtil initIdProperties(String idcard) {
            try {
