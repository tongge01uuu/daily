package test.spring.aspect.declarative;

import daily.spring.aspect.declarative.NormalBusiness;
import daily.spring.aspect.declarative.PlusBusiness;
...
@ContextConfiguration("/application_declarative_test.xml")
