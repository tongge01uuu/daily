...
insert into person(name,age,address) values('1-zz-1',29,'南京');
insert into person(name,age,address) values('1-aa-1',28,'武汉');
insert into person(name,age,address) values('1-bb-1',27,'合肥');