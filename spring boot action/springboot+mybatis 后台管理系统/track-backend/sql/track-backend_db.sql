...
INSERT INTO `cc_resource` (`res_id`, `res_parentId`, `res_name`, `res_status`, `res_model_code`, `res_link_address`, `res_image`, `res_type`, `res_display_order`, `res_remark`, `creator`, `create_time`, `modifier`, `modify_time`) VALUES('14','12','数据明细','0',NULL,'/userFlow/state/toList.do','','2','2','用户流程节点名明细数据',NULL,'2017-08-16 11:26:57',NULL,'2017-08-16 11:26:57');
