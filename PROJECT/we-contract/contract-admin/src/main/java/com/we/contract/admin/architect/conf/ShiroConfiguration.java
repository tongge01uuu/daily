...
import com.we.contract.admin.architect.realm.ShiroDbRealm;
...
public class ShiroConfiguration {
    ...
    public static SecurityManager securityManager(ShiroDbRealm shiroDbRealm, @Qualifier("cacheManager") EhCacheManager cacheManager) {
