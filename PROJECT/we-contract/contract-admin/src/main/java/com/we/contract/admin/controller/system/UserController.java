...
import com.we.contract.admin.architect.utils.CommonHelper;
import com.we.contract.admin.controller.BasicController;
import com.we.contract.admin.domain.system.bo.ExcelExport;
import com.we.contract.admin.domain.system.bo.ResultEntity;
import com.we.contract.admin.domain.system.vo.User;
...
public class UserController extends BasicController {
    ...
    @RequestMapping(value = "/ajax_update_user_pw.do")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value="/ajax_user_list.do")
    @ResponseBody
    public Map<String, Object> ajaxUserList(User user){
        Map<String, Object> result=userService.selectUserResultPageList(user);
        return result;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/ajax_save_user.do")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/ajax_user_fail.do")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/ajax_user_batch_fail.do")
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/ajax_undistributed_role_list.do")
    @ResponseBody
    public Map<String, Object> ajaxUndistributedRoleList(String roleIds){
     ...
     * @param roleIds 已分配角色Id
     */
    @RequestMapping(value = "/ajax_deceased_role_list.do")
    @ResponseBody
    public Map<String, Object> ajaxDeceasedRoleList(String roleIds){
     ...
     * @return
     */
    @RequestMapping(value = "/ajax_save_user_role.do")
    @ResponseBody
